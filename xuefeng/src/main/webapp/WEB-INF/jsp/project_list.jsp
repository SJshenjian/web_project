	...
	<div id="wrap">
		...
		<div class="tabs_header">
			<ul id="ul_tab" class="tabs" style="width:120%">
				...
				<li id="tab_postedit" style="" class="active"><a href="#"><span>项目管理</span></a></li>
				<li><a href="${pageContext.request.contextPath}/project/add"><span>发布新项目</span></a></li>
			</ul>
		</div>
		...
		<table id="lstBox" cellspacing="0">
			<tbody>
				...
				<c:forEach items="${projects}" var="project">
					<tr class="">
						<td class="tdleft"><a href="${pageContext.request.contextPath}/project/detail?id=${project.id}" target="_blank">${project.name}</a><span
							class="gray">（${project.date}）</span></td>
						<td class="tdleft">${project.descript}</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td>${project.count}</td>
						<td>0</td>
						<td><a href="${pageContext.request.contextPath}/project/modify?id=${project.id}">编辑</a> | <a href="${pageContext.request.contextPath}/project/delete?id=${project.id}" name="del">删除</a></td>
					</tr>
				</c:forEach>		
			</tbody>
		</table>		
