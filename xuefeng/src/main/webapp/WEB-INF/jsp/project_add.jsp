	...
	<div id="wrap">
		...
		<div class="tabs_header">
			<ul id="ul_tab" class="tabs" style="width:120%">
				...
				<li><a href="${pageContext.request.contextPath}/blog/list?type=1&pageNum=1"><span>文章管理</span></a></li>				
				...
				<li class="active"><a href="#"><span>发布项目</span></a></li>
			</ul>
		</div>
		...
		<div>
			<input type="text" name="url" value="http://www.xuefeng66.cn/"
				style="width: 560px; height: 20px; background-color: rgb(242, 242, 242);"
				maxlength="100">
		</div>
		...
		<div>
			<input type="submit" value="发布项目" title="保存并跳转">
		</div>
