 ...
 * generated in the com.haotu369.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Execute_QNAME = new QName("http://service.haotu369.com/", "execute");
    private final static QName _ExecuteResponse_QNAME = new QName("http://service.haotu369.com/", "executeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.haotu369.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.haotu369.com/", name = "execute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.haotu369.com/", name = "executeResponse")
