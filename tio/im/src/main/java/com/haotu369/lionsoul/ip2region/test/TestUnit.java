package com.haotu369.lionsoul.ip2region.test;
...
import com.haotu369.lionsoul.ip2region.DataBlock;
import com.haotu369.lionsoul.ip2region.DbConfig;
import com.haotu369.lionsoul.ip2region.DbMakerConfigException;
import com.haotu369.lionsoul.ip2region.DbSearcher;
...
public class TestUnit {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("+---Statistics, Error count = " + errCount + ", Total line = " + lineCount + ", Fail ratio = " + (float) (errCount / lineCount) * 100 + "%");
